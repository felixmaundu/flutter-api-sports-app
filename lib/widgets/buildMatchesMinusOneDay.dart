...
class BuildMatchesMinusOneDay extends StatefulWidget {
  const BuildMatchesMinusOneDay({Key? key}) : super(key: key);

  @override
  State<BuildMatchesMinusOneDay> createState() =>
      _BuildMatchesMinusOneDayState();
}

class _BuildMatchesMinusOneDayState extends State<BuildMatchesMinusOneDay> {
  ...
  void fetchData() async {
    try {
      fixtures = await ApiService.fetchFixturesMinusOneDay();
      setState(() {
        isLoading = false;
      });
    } catch (e) {
