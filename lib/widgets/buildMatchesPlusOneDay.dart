...
class BuildMatchesPlusOneDay extends StatefulWidget {
  const BuildMatchesPlusOneDay({Key? key}) : super(key: key);

  @override
  State<BuildMatchesPlusOneDay> createState() => _BuildMatchesPlusOneDayState();
}

class _BuildMatchesPlusOneDayState extends State<BuildMatchesPlusOneDay> {
  ...
  void fetchData() async {
    try {
      fixtures = await ApiService.fetchFixturesPlusOneDay();
      setState(() {
        isLoading = false;
      });
    } catch (e) {
