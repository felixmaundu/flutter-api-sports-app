...
class HeadToHeadModel {
  ...
  HeadToHeadModel.fromJson(Map<String, dynamic> json) {
    ...
    if (json['response'] != null) {
      response = <ResponseH2H>[];
      json['response'].forEach((v) {
        response!.add(ResponseH2H.fromJson(v));
      });
    }
  }
...
class ResponseH2H {
  ...
  ResponseH2H({this.fixture, this.league, this.teams, this.goals, this.score});

  ResponseH2H.fromJson(Map<String, dynamic> json) {
    fixture =
