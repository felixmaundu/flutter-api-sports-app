...
class TopScorersModel {
  TopScorersModel({
    required this.topScorersModelGet,
  ...
  final String? topScorersModelGet;
  ...
  TopScorersModel copyWith({
    String? topScorersModelGet,
    ...
    return TopScorersModel(
      topScorersModelGet: topScorersModelGet ?? this.topScorersModelGet,
  ...
  @override
  String toString() {
    return "$topScorersModelGet, $parameters, $errors, $results, $paging, $response, ";
  }
}
